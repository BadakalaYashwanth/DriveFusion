class Polygon {
   constructor(points) {
      ...
      this.roadColor = "black"; // Add a property to store the road color
   }
   ...
   // Method to set road color
   setRoadColor(color) {
      this.roadColor = color;
   }

   // Method to draw road with specific color
   drawRoad(ctx, options) {
      this.draw(ctx, { stroke: this.roadColor, fill: "transparent", ...options });
   }
}
