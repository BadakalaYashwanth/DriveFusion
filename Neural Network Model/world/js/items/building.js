class Building {
   ...
   draw(ctx, viewPoint) {
      ...
      this.base.draw(ctx, { fill: "darkgray", stroke: "black", lineWidth: 20 });
      for (const side of sides) {
         side.draw(ctx, { fill: "white", stroke: "yellow" });
   }  

      ceiling.draw(ctx, { fill: "gray", stroke: "gray", lineWidth: 6 });
      for (const poly of roofPolys) {
         poly.draw(ctx, { fill: "#b0c4de", stroke: "#778899", lineWidth: 8, join: "round" });
      }
